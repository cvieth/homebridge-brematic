...
GenericDriver.prototype.encodeMessage = function (targetState) {
    ...
    if (targetState) {
        return HEAD + driver.bitLow + "," + driver.encodeAddress(driver.address.systemCode) + driver.encodeAddress(driver.address.unitCode) + driver.bitHigh + "," + AN + TAILAN;
    } else {
        return HEAD + driver.bitLow + "," + driver.encodeAddress(driver.address.systemCode) + driver.encodeAddress(driver.address.unitCode) + driver.bitHigh + "," + AN + TAILAUS;
    }
};
